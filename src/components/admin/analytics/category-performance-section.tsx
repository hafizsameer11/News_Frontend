...
export function CategoryPerformanceSection({ data }: CategoryPerformanceSectionProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h3 className="text-xl font-semibold mb-6 text-gray-900">Category Performance</h3>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          <h4 className="text-lg font-semibold mb-4 text-gray-900">Distribution Chart</h4>
